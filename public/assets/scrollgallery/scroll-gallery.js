            ...
            function k() {
                ...
                if (b >= a) {
                    ...
                    if (c) {
                        ...
                        switch (!0) {
                            ...
                            case f.classList.contains("moving-left"):
                                ...
                                break;
                            default:
                                2560 <= window.innerWidth ? translateX1 = c.m41 + .9 * (b - a) : 1440 <= window.innerWidth ? translateX1 = c.m41 + .55 * (b - a) : 1024 <=
                    ...
                    if (e) {
                        ...
                        8 <= p && !g.classList.contains("moving-left") &&
                            1200 > window.innerWidth && (e.m41 = 0);
                        switch (!0) {
                            case 8 > p:
                                c();
                    ...
                    if (d) {
                        ...
                        c = d.m41 + .9 * (b - a);
                        8 > l && e();
                        h.classList.contains("moving-left") ? h.classList.contains("moving-left") && (8 > l && e(), 2560 <= window.innerWidth ?
